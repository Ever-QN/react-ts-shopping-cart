...
export default function Navbar() {
    ...
    return (
        <nav className='flex items-center justify-between flex-wrap bg-slate-500 p-6 shadow-xl mb-3 sticky top-0'>
            ...
            { cartQuantity > 0 && (<button className='text-white hover:bg-slate-600 rounded-full p-2 border-2 relative' onClick={openCart}>
                    ...
                    <div className='rounded-full w-5 bg-red-500 absolute bottom-0 right-0 translate-x-1/4 translate-y-1/4'>
                    {cartQuantity}
                    </div>
            </button>
            )}
